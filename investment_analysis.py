...
# output to user
print("The University of Illinois System (UIS) has $" + get_total_capital_in_ff()[0] + " out of the $2,809,677,874.72 operating pool funds (" + str(round((get_total_capital_in_ff()[1]/2809677874.72) * 100, 2)) +"%) invested in " + str(len(get_ff_comps())) + " companies that profit from the extraction, transportation, or combustion of coal, petroleum, or natural gas.", '\n')
